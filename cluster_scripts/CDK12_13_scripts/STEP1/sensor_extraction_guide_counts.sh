...
#SBATCH --array=1-62    #change this to match up with the number of parallel computing jobs; also generate a config file 
...
cd /net/bmc-lab2/data/lab/sanchezrivera/samgould/250612San

#access the config file
#NEED TO CHANGE THE CONFIG FILE FOR YOUR SPECIFIC RUN
config=./CDK12_13_config.txt
