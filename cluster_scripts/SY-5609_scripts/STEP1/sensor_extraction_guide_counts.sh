...
#SBATCH --array=1-48    #change this to match up with the number of parallel computing jobs; also generate a config file 
...
cd /net/bmc-lab2/data/lab/sanchezrivera/samgould/250321San

#access the config file
#NEED TO CHANGE THE CONFIG FILE FOR YOUR SPECIFIC RUN
config=./SY_5609_config.txt
