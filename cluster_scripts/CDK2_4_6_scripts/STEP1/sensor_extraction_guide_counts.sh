...
#SBATCH --array=1-49    #change this to match up with the number of parallel computing jobs; also generate a config file 
...
cd /net/bmc-lab2/data/lab/sanchezrivera/samgould/250728San

#access the config file
#NEED TO CHANGE THE CONFIG FILE FOR YOUR SPECIFIC RUN
config=./CDK2_4_6_config.txt
