...
#SBATCH --array=1-15,41-49    #change this to match up with the number of parallel computing jobs; also generate a config file 
...
python3 sensor_HGVSp_pipeline_v2.py master_df_HGVSp_quant_pool3.csv cdks_info_updated.csv ${EDITOR} ${folder_name}
