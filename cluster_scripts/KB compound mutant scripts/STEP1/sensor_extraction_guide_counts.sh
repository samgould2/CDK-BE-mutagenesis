...
#SBATCH --array=1-24    #change this to match up with the number of parallel computing jobs; also generate a config file 
...
cd /net/bmc-lab2/data/lab/sanchezrivera/samgould/250505San

#access the config file
#NEED TO CHANGE THE CONFIG FILE FOR YOUR SPECIFIC RUN
config=./KB_compound_mut_config.txt
...
python3 sensor_extraction_guide_counts.py CDK_library_CLUSTER.csv ${R1_FILE} ${R2_FILE} ${splitby} ${proto_mismatches_allowed} ${bc_len} ${sensor_len} -o ${folder_name}
